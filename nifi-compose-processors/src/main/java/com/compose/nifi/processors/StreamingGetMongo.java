...
@ReadsAttribute(attribute="mongoObjectId", description="The mongo id of the first object ot fetch")
@WritesAttributes({
...
public class StreamingGetMongo extends AbstractProcessor {
    ...
    private static final PropertyDescriptor WAIT_TIME = new PropertyDescriptor.Builder()
            .name("Wait time")
            .description("The time in milliseconds to wait between getting the next document.")
            .required(true)
            .defaultValue("0")
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build();
...
//                    ProcessSession session = sessionFactory.createSession();
		...
		getLogger().error("{} failed to process due to {}; rolling back session", new Object[]{this, e});
